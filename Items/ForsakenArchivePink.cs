...
{
    public class ForsakenArchivePink : ModItem
    {
        public override string Texture => "CalamityMod/Items/Weapons/Magic/GruesomeEminence";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Forsaken Archive Placer (Pink)");
            /* Tooltip.SetDefault("Places a pink Forsaken Archive on your cursor when used\n" +
